...
public class DanhSachVideo extends AppCompatActivity implements VideoListAdapter.VieoItemListener {
   ...
   private YouTubePlayer mYouTubePlayer;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bottomNavigationView = (BottomNavigationView) findViewById(R.id.nagivation__bottom2);
        bottomNavigationView.setSelectedItemId(R.id.menu_chitietbaihoc);

        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.menu_chitietbaihoc:
                    startActivity(new Intent(getApplicationContext(), ChiTietActivity.class));
